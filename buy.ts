...
import { initDiscordBot, logTransaction } from './discord';
...
async function buy(accountId: PublicKey, accountData: LiquidityStateV4): Promise<void> {
    try {
        ...
        if (!confirmation.value.err) {
            ...
            //TRANS MESSAGE
            logTransaction(accountData.baseMint, `https://solscan.io/tx/${signature}?cluster=${NETWORK}`);
...
function loadSnipeList() {
    ...
    // console.log(snipeList);
    // console.log(snipeList.length);
