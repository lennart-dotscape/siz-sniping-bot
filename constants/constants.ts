...
export const DISCORD_TOKEN = retrieveEnvVariable('DISCORD_TOKEN', logger);
export const DISCORD_CLIENT_ID = retrieveEnvVariable('DISCORD_CLIENT_ID', logger);
export const GUILD_ID = retrieveEnvVariable('GUILD_ID', logger);
